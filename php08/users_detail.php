  ...
  <div class="jumbotron">
   <fieldset>
    <legend>学校：先生/学生登録</legend>
     ...
     <label>管理FLG：
      一般（学生）<input type="radio" name="kanri_flg" value="0"<?php if (isset($res["kanri_flg"]) && ($res["kanri_flg"])=="0") echo "checked";?>>
      管理者（先生）<input type="radio" name="kanri_flg" value="1"<?php if (isset($res["kanri_flg"]) && ($res["kanri_flg"])=="1") echo "checked";?>>
    </label>
    <br>
     <label>在学FLG：
      在学<input type="radio" name="life_flg" value="0"<?php if (isset($res["life_flg"]) && ($res["life_flg"])=="0") echo "checked";?>>
      卒業<input type="radio" name="life_flg" value="1"<?php if (isset($res["life_flg"]) && ($res["life_flg"])=="1") echo "checked";?>>
